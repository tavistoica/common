...
exports.requireRestaurant = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, require_auth_1.requireAuth(req, res, function () {
                    ...
                    var decodedToken = jsonwebtoken_1.decode(authHeader);
                    if (((_a = decodedToken) === null || _a === void 0 ? void 0 : _a.role) !== user_types_1.UserEnum.Restaurant) {
                        throw new not_authorized_error_1.NotAuthorizedError();
                    }
                })];
            case 1:
